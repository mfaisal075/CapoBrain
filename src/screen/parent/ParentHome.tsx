        ...
        <View style={styles.studentDetails}>
          ...
          <View style={styles.otherDetails}>
            <View style={styles.otherDetailsContainer}>
              ...
              />
              <Text style={styles.otherDetailsText}>Abdullah</Text>
            </View>
            <View style={styles.otherDetailsContainer}>
              <Image
          ...
          <View style={styles.accountStatus}>
            ...
            <View style={styles.statusDetails}>
              <Text style={styles.statusDetailsText}>Receivable: 12500</Text>
            </View>
            <View style={styles.statusDetails}>
              <Text style={styles.statusDetailsText}>Paid: 8000</Text>
            </View>
            <View style={styles.statusDetails}>
              <Text style={styles.statusDetailsText}>Inventory: 1500</Text>
            </View>
            <View style={styles.statusDetails}>
              <Text style={styles.statusDetailsText}>Balance: 4500</Text>
            </View>
          </View>
        </View>
        {/* Buttons Container */}
